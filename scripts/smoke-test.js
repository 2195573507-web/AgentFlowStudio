...
check('static Liquid Glass token set exists', ['--glass-surface', '--glass-surface-hover', '--glass-border', '--glass-highlight', '--glass-inner', '--focus-ring'].every((keyword) => staticCss.includes(keyword)))
...
const glassCard = readText('src/renderer/components/GlassCard.tsx')
